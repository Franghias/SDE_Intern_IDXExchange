...
- **User Flow**:
  ...
  6. **Multi-Column Sorting**: `SortControls` allows sorting open house results by price, date, sqft, beds, or baths.
...
- `GET /api/properties` — Search, filter, multi-sort, and `hasOpenHouse` indicator query (sub-5ms index scan).
